...
\titlespacing*{\section}{0cm}{*1.2}{*1.5}	% 标题左边留白，上方 1.2 倍，下方 1.5 倍
...
\begin{document}
    ...
    \begin{minipage}[b]{\textwidth} % 为了方便排版，将双栏内容装在一个额外的 minipage 中
    \begin{minipage}[t]{0.78\textwidth}
        ...
        \begin{tabularx}{\linewidth}{p{\widthof{出生日期:}}Xp{\widthof{政治面貌:}}X}
            ...
            政治面貌: & 你的政治面貌 \\
            %% 想多加几行的话，就按上面的格式自行补充
        \end{tabularx} \ % 这里添加了一个空格，为了让表格后的行间距和普通段落相同
    ...
    \end{minipage}        
    \end{minipage} \ % 这里添加了一个空格，为了让 minipage 后的行间距和普通段落相同
