...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \href{mailto:youremail@seu.edu.cn}{\faEnvelope\quad youremail@seu.edu.com}
        \hspace{4em}
        % 手机号
        \href{tel:130-6666-0000}{\faPhone\quad 130-6666-0000}
        % 别的联系方式，如微信、GitHub等
        \hspace{4em}
        \href{https://github.com/Exception0x0194/SEU-CV}{\faGithub\quad GitHub 项目地址}
    }
}
